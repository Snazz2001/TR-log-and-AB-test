...
loan3$AmCollected<-ifelse(is.na(loan3$AmCollected),0,loan3$AmCollected);# may use the following one
loan3$ThirdCollectedAmount<-ifelse(is.na(loan3$ThirdCollectedAmount),0,loan3$ThirdCollectedAmount);
loan3$SecondCollectedAmount<-ifelse(is.na(loan3$SecondCollectedAmount),0,loan3$SecondCollectedAmount);
loan3$ThirdTopAmount<-ifelse(is.na(loan3$ThirdTopAmount),0,loan3$ThirdTopAmount);#handling the missing value
...
loanbin<-c(100,200,300,400,500,600,700,800,900,1300);
collectedratioloan<-c(1.524332,1.432247,1.423011,1.338516,1.307022, 1.315821,1.331069,1.306929,1.246413,1.138899);#this is collectratio for ctr frozen comparison with collectratio for ctr increase                    		     c(1.909995,1.599367,1.482607,1.383184,1.290574,1.190397,1.147617,1.136514,1.048569,1.038715)

threshold<-seq(0.01,0.2,by=0.01);
threshold<-seq(0.000,1,by=0.005);
frozenprop<-rep(0,length(threshold));
...
collectRatioold<-rep(0,length(threshold));
numberaffected<-rep(0,length(threshold));
datafeb2$weightAmount<-sapply(datafeb2$ThirdLoanAmountAgreed, function(x)weightsbin[min(which(loanbin>=x))]);
for(i in 1:length(threshold))
 {
     datafeb2$PredOutcome<-ifelse(datafeb2$nn.pred<threshold[i],0,1);
	 
	 trscore[i]<-(1-threshold[i])*1000;
	
	#weightsbin[min(which(loanbin>s))];
	
	datafeb2$newTR3<-ifelse(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1,datafeb2$ThirdTrustRating,ifelse(datafeb2$PredOutcome==1&datafeb2$TrUpdate==0,datafeb2$ThirdTrustRating,ifelse(datafeb2$PredOutcome==0&datafeb2$TrUpdate==0,datafeb2$SecondTrustRating+trIncreaseMean,datafeb2$SecondTrustRating)));
	
	datafeb2$newTR3<-ifelse(datafeb2$newTR3>1000,1000,datafeb2$newTR3);

	datafeb2$newLoanMin<-apply(data.frame(datafeb2$newTR3,datafeb2$ThirdLoanAmountAgreed),1,min);
	
	#datafeb2$value<-log(1000/datafeb2$ThirdMixedScore-1);
	...
	#datafeb2$newMixedScore<-1000/(1+exp(datafeb2$value-datafeb2$weightAmount+datafeb2$weightAmount2));

	#datafeb2$newCollectedRatio<-sapply(datafeb2$newMixedScore, function(x)collectedpratio[min(which(scorebin>=x))]);
	
	datafeb2$newCollectedRatio<-sapply(datafeb2$newLoanMin, function(x)collectedratioloan[min(which(loanbin>=x))]);
	
	datafeb2$newCollected<-datafeb2$newCollectedRatio*datafeb2$newLoanMin;
	
	#datafeb2$badCollectedRatio<-datafeb2$AmCollected/datafeb2$ThirdLoanAmountAgreed;
	
	#datafeb2$badNewCollected<-datafeb2$badCollectedRatio*datafeb2$newLoanMin;
	
	 #collectRatio[i]<-(sum(datafeb2$badNewCollected[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$AmCollected[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0)]))/(sum(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0)]));	 
	 
	 collectRatio[i]<-(sum(datafeb2$newCollected[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$AmCollected[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0)]))/(sum(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0)]));
	 
	 #collectRatio[i]<-(sum(datafeb2$newCollected[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]))/(sum(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]));
	 collectRatioold[i]<-sum(datafeb2$AmCollected[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])/sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]);
	 #loanAmount[i]<-sum(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])
	 loanAmount[i]<-sum(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0)]);
	 numberaffected[i]<-sum(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1);
	 meanLoanAmount[i]<-mean(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]);
	 trueLoanAmount[i]<-sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]);
	 frozenprop[i]<-dim(datafeb2[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1),])[1]/dim(datafeb2[which(datafeb2$TrUpdate==1),])[1]
	 if(length(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])>0)
	 {arrearrate[i]<-length(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$ThirdBad==1&datafeb2$TrUpdate==1)])/length(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]);
	  arrearrateall[i]<-(sum(datafeb2$TrUpdate==0&datafeb2$ThirdBad==1)+sum(datafeb2$TrUpdate==1&datafeb2$ThirdBad==1&datafeb2$PredOutcome==0)+sum(datafeb2$TrUpdate==1&datafeb2$PredOutcome==1)*arrearfrozen)/dim(datafeb2)[1];
	 }
	 else
	 {arrearrate[i]<-0;
	arrearrateall[i]<-0;	
...
results7<-data.frame(trscore,loanAmount,trueLoanAmount,meanLoanAmount,arrearrate,frozenprop,arrearrateall,collectRatio,collectRatioold,numberaffected);
...
sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed>900)])/sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed>900)])
sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=900&datafeb2$ThirdLoanAmountAgreed>800)])/sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=900&datafeb2$ThirdLoanAmountAgreed>800)])
sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=800&datafeb2$ThirdLoanAmountAgreed>700)])/sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=800&datafeb2$ThirdLoanAmountAgreed>700)])
sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=700&datafeb2$ThirdLoanAmountAgreed>600)])/sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=700&datafeb2$ThirdLoanAmountAgreed>600)])
sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=600&datafeb2$ThirdLoanAmountAgreed>500)])/sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=600&datafeb2$ThirdLoanAmountAgreed>500)])
sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=500&datafeb2$ThirdLoanAmountAgreed>400)])/sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=500&datafeb2$ThirdLoanAmountAgreed>400)])
sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=400&datafeb2$ThirdLoanAmountAgreed>300)])/sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=400&datafeb2$ThirdLoanAmountAgreed>300)])
sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=300&datafeb2$ThirdLoanAmountAgreed>200)])/sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=300&datafeb2$ThirdLoanAmountAgreed>200)])
sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=200&datafeb2$ThirdLoanAmountAgreed>100)])/sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=200&datafeb2$ThirdLoanAmountAgreed>100)])
sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=100)])/sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0&datafeb2$ThirdLoanAmountAgreed<=100)])

datafeb2$scoreband<-ifelse(datafeb2$score<=100,1,ifelse(datafeb2$score<=200,2,ifelse(datafeb2$score<=300,3,ifelse(datafeb2$score<=400,4,ifelse(datafeb2$score<=500,5,ifelse(datafeb2$score<=600,6,ifelse(datafeb2$score<=700,7,ifelse(datafeb2$score<=800,8,ifelse(datafeb2$score<=900,9,10)))))))))

--------------THE BELOW IS TO ANALYZE THE INCREASE TRUST RATING PART-------------------------------------------------
loanbin<-c(50,99,116,152,200,260,2000);
weightsbin<-c(-1.39078008542745,-0.976685538270457,-0.884872443666457,-0.731901063935573,-0.649597719144209,-0.549783318707196,0)

scorebin<-c(600,650,700,750,800,850,900,950,1000);
collectedpratio1<-c(1.074714768,1.002852664,1.021439181,1.142469586,1.195870951,1.216786728,1.288965395,1.361027762,1.331448534)
collectedpratio2<-c(1.10888,1.031067,1.032878,1.156767,1.202067,1.226311,1.301306,1.368416,1.333416)

#loanbin<-c(100,200,300,400,500,600,700,800,900,1300);
collectedratioloan<-c(1.524332,1.432247,1.423011,1.338516,1.307022, 1.315821,1.331069,1.306929,1.246413,1.138899);#this is collectratio for ctr frozen comparison with collectratio for ctr increase                    		     c(1.909995,1.599367,1.482607,1.383184,1.290574,1.190397,1.147617,1.136514,1.048569,1.038715)
collectedratioloan<-c(1.188443,1.150711,1.149652,1.079758,  1.078102, 1.092907,1.141444,1.168288,1.144137,1.128967);
...
arrearfrozen<-0.064;
collectRatio<-rep(0,length(threshold));
collectRatio1<-rep(0,length(threshold));
collectRatio2<-rep(0,length(threshold));
collectRatioold<-rep(0,length(threshold));
numberaffected<-rep(0,length(threshold));
datafeb2$weightAmount<-sapply(datafeb2$ThirdLoanAmountAgreed, function(x)weightsbin[min(which(loanbin>=x))]);
for(i in 1:length(threshold))
 {
	...
	#datafeb2$newLoanMin<-apply(data.frame(datafeb2$newTR3,datafeb2$ThirdLoanAmountAgreed),1,min);
	datafeb2$newLoanMin<-apply(data.frame(datafeb2$newTR3,datafeb2$ThirdLoanAmountTotal),1,min);
	...
	#datafeb2$newCollectedRatio<-sapply(datafeb2$newMixedScore, function(x)collectedpratio[min(which(scorebin>=x))]);
	#datafeb2$newCollectedRatio<-sapply(datafeb2$ThirdMixedScore, function(x)collectedpratio[min(which(scorebin>=x))]);
	
	datafeb2$newCollectedRatio1<-sapply(datafeb2$newMixedScore, function(x)collectedpratio1[min(which(scorebin>=x))]);
	datafeb2$newCollectedRatio2<-sapply(datafeb2$newMixedScore, function(x)collectedpratio2[min(which(scorebin>=x))]);
	
	datafeb2$newCollected1<-datafeb2$newCollectedRatio1*datafeb2$newLoanMin;
	datafeb2$newCollected2<-datafeb2$newCollectedRatio2*datafeb2$newLoanMin;
	
	#datafeb2$newCollectedRatio<-sapply(datafeb2$newLoanMin, function(x)collectedratioloan[min(which(loanbin>=x))]);
	
	#datafeb2$newCollected<-datafeb2$newCollectedRatio*datafeb2$newLoanMin;
	
	#datafeb2$newCollectedRatio<-datafeb2$ThirdCollectedAmount/datafeb2$ThirdLoanAmountTotal;
	
	#datafeb2$NewCollected<-datafeb2$newCollectedRatio*datafeb2$newLoanMin;
	
	 #collectRatio[i]<-(sum(datafeb2$badNewCollected[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$AmCollected[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$AmCollected[which(datafeb2$TrUpdate==0)]))/(sum(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0)]));	 
	 
	 collectRatio1[i]<-(sum(datafeb2$newCollected1[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdCollectedAmount[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdCollectedAmount[which(datafeb2$TrUpdate==0)]))/(sum(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountTotal[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountTotal[which(datafeb2$TrUpdate==0)]));
	 
	 collectRatio2[i]<-(sum(datafeb2$newCollected2[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdCollectedAmount[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdCollectedAmount[which(datafeb2$TrUpdate==0)]))/(sum(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountTotal[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountTotal[which(datafeb2$TrUpdate==0)]));
	 ...
	 #collectRatio[i]<-(sum(datafeb2$newCollected[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]))/(sum(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]));
	 #collectRatioold[i]<-sum(datafeb2$AmCollected[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])/sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]);
	 collectRatioold[i]<-sum(datafeb2$ThirdCollectedAmount[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])/sum(datafeb2$ThirdLoanAmountTotal[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]);
	 #loanAmount[i]<-sum(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])
	 loanAmount[i]<-sum(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountTotal[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountTotal[which(datafeb2$TrUpdate==0)]);
	  #loanAmount[i]<-sum(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$PredOutcome==0&datafeb2$TrUpdate==1)])+sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$TrUpdate==0)]);
	 numberaffected[i]<-sum(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1);
	 meanLoanAmount[i]<-mean(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]);
	 #trueLoanAmount[i]<-sum(datafeb2$ThirdLoanAmountAgreed[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]);
	 trueLoanAmount[i]<-sum(datafeb2$ThirdLoanAmountTotal[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]);
	 frozenprop[i]<-dim(datafeb2[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1),])[1]/dim(datafeb2[which(datafeb2$TrUpdate==1),])[1]
	 if(length(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)])>0)
	 {arrearrate[i]<-length(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$ThirdBad==1&datafeb2$TrUpdate==1)])/length(datafeb2$newLoanMin[which(datafeb2$PredOutcome==1&datafeb2$TrUpdate==1)]);
	  arrearrateall[i]<-(sum(datafeb2$TrUpdate==0&datafeb2$ThirdBad==1)+sum(datafeb2$TrUpdate==1&datafeb2$ThirdBad==1&datafeb2$PredOutcome==0)+sum(datafeb2$TrUpdate==1&datafeb2$PredOutcome==1)*arrearfrozen)/dim(datafeb2)[1];
...
results12<-data.frame(trscore,loanAmount,trueLoanAmount,meanLoanAmount,arrearrate,frozenprop,arrearrateall,collectRatio,collectRatioold,numberaffected);